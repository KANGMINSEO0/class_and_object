...
public class User {
    ...
    *  통상적으로 필드 선언부와 메소드 선업부 사이에 작성하는 것이 관례이다.
    * */
...
//    public User() {}
    // 매개변수가 있는 생성자를 사용할 시에는 기본생성자를 꼭 만들어줘야한다.
...
//        this.enrollDate = enrollDate;
        ...
        * */
        ...
        this(id, pwd, name);        // 위에 있는 생성자 구문을 호출
        this.enrollDate = enrollDate;
...
//        this.enrollDate = otherUser.enrollDate;
        ...
        System.out.println("otherUser의 hashcode : " + otherUser.hashCode()); // 값은 같지만 주소값은 다름
    }

    public String getInformation() {

        return "User [id=" + this.id + ", pwd=" + this.pwd + ", name=" +  this.name + ", enrollData=" + this.enrollDate + "]";
