...
public class Application {
    public static void main(String[] args) {
        ...
        /* 필기.
        *  생성자란?
        *  인스턴스를 생성할 때 초기 수행할 명령이 있는 경우에는 미리 작성해두고, 인스턴스를 생성할 때 호출된다.
        *  생성자 함수에 매개변수가 없는 생성자를 기본생성자(defualt constructor)라고 하며,
        *  기본생성자는 compiler에 의해 자동으로 추가되기 때무에 지금까지 명시적으로 작성하지 않고 사용할 수 있었다.
        * */
