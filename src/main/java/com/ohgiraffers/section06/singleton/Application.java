...
public class Application {
    public static void main(String[] args) {
        ...
        * */
        ...
        /*  1. 이른 초기화(Eager Initialization) */
//        EagerSingletone eager = new EagerSingleton(); pivate 으로 만들었기 때문에
        EagerSingleton eager1 = EagerSingleton.getInstance();
        EagerSingleton eager2 = EagerSingleton.getInstance();

        System.out.println(eager1.hashCode());
        System.out.println(eager2.hashCode());  // 둘의 주소값은 똑같다 => 두 객체는 같은 객체이다 = 동일한 인스턴스이다.
        ...
        System.out.println(lazy2.hashCode());   // 둘의 주소값은 똑같다
